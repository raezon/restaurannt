...
<div id="1">
    ...
    <div class="col text-center"><button id="imp" class="bg-teal-500 hover:bg-teal-700 text-white font-bold  rounded" type="button" style="width: 150px;height: 50px;margin: 20px;">Imprimer الفاتورة</button></div>
