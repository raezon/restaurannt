...
<div class="max-w-4xl mx-auto mt-8">
    ...
    <div class="flex justify-end mt-10">
        <a href="{{ route('customers.create') }}" class="px-2 py-1 rounded-md bg-blue-500 text-sky-100 hover:bg-blue-700">create customer</a>
    </div>
            ...
            <div class="inline-block min-w-full overflow-hidden align-middle border-b border-gray-200 shadow sm:rounded-lg">
                ...
                <table class="min-w-full">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-xs font-medium leading-4 tracking-wider text-left text-gray-500 uppercase border-b border-gray-200 bg-gray-50">Addresse</th>
                        <th class="px-6 py-3 text-xs font-medium leading-4 tracking-wider text-left text-gray-500 uppercase border-b border-gray-200 bg-gray-50">phone_number</th>
                    ...
                    <tbody class="bg-white">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">{{ $element->fullName }}</td>
                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">{{ $element->email }}</td>
                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">{{ $element->addresse }}</td>
                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">{{ $element->phone_number }}</td>
                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                <form action="{{ route('customers.destroy',$element->id) }}" method="POST">

                                    <a class="text-indigo-600 hover:text-indigo-900" href="{{ route('customers.show',$element->id) }}">
                                    ...
                                    <a href="{{ route('customers.edit',$element->id) }}" class="text-indigo-600 hover:text-indigo-900 text-gray-600">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 inline-block" fill="none" viewBox="0 0 24 24" stroke="currentColor">
