...
<div class="max-w-4xl mx-auto mt-8">
    ...
    <div class="flex justify-end mt-10">
        <a href="{{ route('ingrediants.create') }}" class="px-2 py-1 rounded-md bg-blue-500 text-sky-100 hover:bg-blue-700">+ Create New Ingrediant</a>
    </div>
                    ...
                    <tbody class="bg-white">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                <form action="{{ route('ingrediants.destroy',$element->id) }}" method="POST">

                                    <a class="text-indigo-600 hover:text-indigo-900" href="{{ route('ingrediants.show',$element->id) }}">
