...
<div class="max-w-4xl mx-auto mt-8">
    ...
    <div class="flex justify-end mt-10">
        <a href="{{ route('categories.create') }}" class="px-2 py-1 rounded-md bg-blue-500 text-sky-100 hover:bg-blue-700">+ Create New Category</a>
    </div>
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                <form action="{{ route('categories.destroy',$element->id) }}" method="POST">
                                    ...
                                    <a class="text-indigo-600 hover:text-indigo-900" href="{{ route('categories.show',$element->id) }}">
                                    ...
                                    <a href="{{ route('categories.edit',$element->id) }}" class="text-indigo-600 hover:text-indigo-900 text-gray-600">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 inline-block" fill="none" viewBox="0 0 24 24" stroke="currentColor">
