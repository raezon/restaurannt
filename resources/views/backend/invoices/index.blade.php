            ...
            <div class="inline-block min-w-full overflow-hidden align-middle border-b border-gray-200 shadow sm:rounded-lg">
                ...
                <table class="min-w-full">
                    ...
                    <th class="px-6 py-3 text-xs font-medium leading-4 tracking-wider text-left text-gray-500 uppercase border-b border-gray-200 bg-gray-50">Id</th>
                        <th class="px-6 py-3 text-xs font-medium leading-4 tracking-wider text-left text-gray-500 uppercase border-b border-gray-200 bg-gray-50">Customer name</th>
                        <th class="px-6 py-3 text-xs font-medium leading-4 tracking-wider text-left text-gray-500 uppercase border-b border-gray-200 bg-gray-50">total Price</th>
                    ...
                    <tbody class="bg-white">
                        ...
                        <tr>
                        <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">{{ ++$key }}</td>
                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">{{ $element->name }}</td>
                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">{{ $element->totalPrice }}</td>
                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                <form action="{{ route('invoices.destroy',$element->id) }}" method="POST">

                                    <a class="text-indigo-600 hover:text-indigo-900" href="{{ route('invoices.show',$element->id) }}">
