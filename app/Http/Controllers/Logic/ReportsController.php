...
{
    public function __construct(ReportsRepositoryInterface  $repository,PresenterDispatcher $presenter) 
    {
    ...
    public function index(Request $request)
    {
        ...
        return $this->presenter->handle(['name' => 'backend.reports.index', 'data' => $data]);
    }
